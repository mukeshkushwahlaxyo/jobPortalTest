...
if (! function_exists('get_chat_status_name')) {
    ...
    {
        switch ($status) {
            case ChatConversation::STATUS_NEW: return trans('app.statuses.new');
            case ChatConversation::STATUS_READ: return trans('app.statuses.read');
            case ChatConversation::STATUS_UNREAD: return trans('app.statuses.unread');
        }
    }
}
...
if (! function_exists('get_cancellation_reason_txt')) {
    ...
    {
        switch ($status) {
            case Cancellation::STATUS_NEW: return trans('app.statuses.new');
            case Cancellation::STATUS_OPEN: return trans('app.statuses.open');
            case Cancellation::STATUS_APPROVED: return trans('app.statuses.approved');
            case Cancellation::STATUS_DECLINED: return trans('app.statuses.declined');
        }
    }
}
...
if (! function_exists('get_deal_of_the_day')) {
    ...
    {
        return Inventory::find(get_from_option_table('deal_of_the_day'));
    }
}
