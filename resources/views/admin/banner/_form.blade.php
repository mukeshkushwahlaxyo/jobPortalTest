<div class="row">
  <div class="col-md-9 nopadding-right">
    <div class="form-group">
      ...
      {!! Form::text('title', null, ['required'=>true,'class' => 'form-control', 'placeholder' => trans('app.placeholder.title')]) !!}
    ...
    <div class="form-group">
      ...
      {!! Form::text('description', null, ['required'=>true,'class' => 'form-control', 'placeholder' => trans('app.placeholder.banner_description')]) !!}
      <div class="help-block with-errors"></div>
    </div>
    ...
    <div class="row">
      <div class="col-md-6 nopadding-right">
        <div class="form-group">
          {!! Form::label('group_type_id', trans('Group Type').'*', ['class' => 'with-help']) !!}
          <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('help.banner_group') }}"></i>
          <select name="group_type" class="form-control select2-normal group_type_id" required>
            <option>Select..</option>
            @foreach($groupsType as $type)
              <option {{isset($banner) ? $banner->group_type=== $type->type ?  'selected' : '' :'' }} value="{{$type->type}}">{{$type->type_name}}</option>
            @endforeach
          </select>          
          <div class="help-block with-errors"></div>
        </div>
    ...
    <div class="row">
      <div class="col-md-3 nopadding-right">
        <div class="form-group">
          ...
          <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('help.banner_group') }}"></i>
          <span><i class="fa fa-spinner fa-spin text-danger hidden" style="font-size:24px"></i><span>
          {!! Form::select('group_id',[], null, ['class' => 'form-control select2-normal gropus','required'=>true ,'placeholder' => trans('app.placeholder.group')]) !!}
          <div class="help-block with-errors"></div>
        </div>
      </div>
      ...
      <div class="col-md-3 nopadding-left">
        <div class="form-group">
          ...
          {!! Form::number('order' , null, ['required'=>true,'class' => 'form-control order', 'max'=> 6,'min'=> 1,'placeholder' => trans('app.placeholder.position')]) !!}
          <div class="help-block with-errors"></div>
        </div>
      </div>
      ...
      <div class="col-md-3 ">
        <div class="form-group">
          {!! Form::label('Mobile Order', trans('Mobile Order'), ['class' => 'with-help']) !!}
          <i class="fa fa-question-circle" data-toggle="tooltip" data-placement="top" title="{{ trans('help.banner_order') }}"></i>
          {!! Form::number('mobile_order' , null, ['required'=>true,'class' => 'form-control order', 'max'=> 6,'min'=> 1,'placeholder' => trans('app.placeholder.position')]) !!}
          <div class="help-block with-errors"></div>
        </div>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      @if(isset($banner) && Storage::exists(optional($banner->featureImage)->path))
        <img id="bannerImage" src="{{ get_storage_file_url(optional($banner->featureImage)->path, 'small') }}" width="" alt="{{ trans('app.banner_image') }}">
      ...
      <div class="row">
        <div class="col-md-9 nopadding-right">
          ...
          <span id="sizeImage" class="text-danger"></span>
        </div>
        <div class="col-md-3 nopadding-left">
  ...
  <div class="col-md-3 nopadding-left">
    ...
    <img id="designerHome" class="" src="{{ asset('images/placeholders/DesignersHome(wireframe).jpg') }}" width="80%" height="450px" align="right">  
    <img id="MenHome" class="hidden" src="{{ asset('images/placeholders/Menswear(Wireframe).jpg') }}" width="80%" height="450px" align="right">  
    <img id="OfferHome" class="hidden" src="{{ asset('images/placeholders/Offerspage(Wireframe).jpg') }}" width="80%" height="450px" align="right">  
  </div> <!--/.col-md-3 -->
</div> <!--/.row -->
...
@if(isset($banner))
  <script>
    $(document).ready(function(){
      getGroups('{{$banner->group_type}}','{{$banner->group_id}}')      
    })
  </script>
@endif